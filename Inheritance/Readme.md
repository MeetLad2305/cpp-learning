...
Use Single Inheritance where the IssuedBook class inherits the properties of the Book class. Constructors should be used to initialize all data members, and member functions should display the complete issued book information.
